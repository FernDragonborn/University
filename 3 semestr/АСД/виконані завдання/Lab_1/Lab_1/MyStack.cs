    ...
    public class MyStack
    {
        ...
        public void Pop()
        {
            if (_Top != null && _Top._L != null)
            {
                ...
                temporary = _Top._L;
                _Top = temporary;
                MessageBox.Show("Видалено останній введений елемент");
                return;
            }
            ...
            MessageBox.Show("Не можна очистити пустий стек");
        }
        public bool Empty()
        {
            if (_Top == null)
        ...
        public void StackContaintment()
        {
            if (_Top != null)
            {
                ...
                MessageBox.Show("Вміст стеку: " + dataofstack + "\nКількість елементів: " + i);
                return;
            }
        ...
        public void Peek()
        {
            if(_Top!=null)
            {
                MessageBox.Show("Останній доданий елемент - " + _Top._data.ToString());
                return;
            }
            MessageBox.Show("Немає доданих елементів");
        }
    }
}
